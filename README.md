...
> [!NOTE]
> This is a fork from [cnstark/pytorch-docker](https://github.com/cnstark/pytorch-docker) supporting almost all combinations of pytorch 1.4-2.6, python 3.8-3.13, ubuntu 18.04-22.04, centos 8, and cuda 10.0-12.6.
